...
base as (
    ...
    select
        ...
        md5(cast(id as varchar) || cast(_sdc_extracted_at as varchar)) as weather_id,
        ...
        coalesce(main__temp, cast(main ->> 'temp' as decimal)) - 273.15 as temperature,
        coalesce(main__temp_max, cast(main ->> 'temp_max' as decimal)) - 273.15 as temperature_temp_max,
        coalesce(main__temp_min, cast(main ->> 'temp_min' as decimal)) - 273.15 as temperature_temp_min,
        coalesce(main__feels_like, cast(main ->> 'feels_like' as decimal)) - 273.15 as temperature_feels_like,
        
        -- 5. Atmospheric Metrics
        coalesce(main__humidity, cast(main ->> 'humidity' as decimal)) as humidity, 
        coalesce(main__pressure, cast(main ->> 'pressure' as decimal)) as pressure, 
        ...
        -- 8. Wind
        coalesce(wind__deg, cast(wind ->> 'deg' as decimal)) as wind_direction, 
